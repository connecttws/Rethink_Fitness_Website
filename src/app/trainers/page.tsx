      ...
      <section className={styles.hero}>
        <div className="container">
          <h1 className={styles.heroTitle}>
            Meet Your <span className="text-accent">Transformation Experts</span>
          </h1>
          <p className={styles.heroDesc}>
            Our coaching staff isn't just certified—they are masters of their craft. Learn more about the elite professionals who will guide you to your goals.
          </p>
        </div>
      </section>
