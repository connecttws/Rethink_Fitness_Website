        ...
        <section className={styles.hero}>
          <div className={`container ${styles.containerRelative}`}>
            <h1 className={styles.heroTitle}>
              Nutrition Structured for Your <span className="text-accent">Metabolism</span>
            </h1>
            <p className={styles.heroDesc}>
              Workouts break down muscle tissue; what you eat determines whether you build lean muscle or stay stuck. At Rethink Fitness, nutrition is integrated directly into our personal training packages.
            </p>
          </div>
        </section>
